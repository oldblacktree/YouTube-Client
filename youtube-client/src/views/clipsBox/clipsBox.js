    ...
    clipsData.forEach((clipData) => {
      ...
      clip.innerHTML = `
        <div class="clip-container">
          <div class="clip-head">
            <img class="clip-head__image" src="${clipData.image}" alt="${
  clipData.title
}">
            <a class="clip-head__title" href="https://www.youtube.com/watch?v=${
  clipData.id
}">${clipData.title}</a>
          </div>
          <div class="clip-info">
...
// author: 'DarkSquidge';
// date: '2018-08-13';
// description: "Every asdfmovie so far! - More asdfmovie! (https://www.youtube.com/playlist?list=PL3A5849BDE0581B19)↵asdfmovie merch (http://sharkrobot.com/asdfmovie)↵Animation + Music Credits Below!↵↵asdfmovie1↵James 'GlassCake' Cunningham (animator): http://youtube.com/EpikkuFeiru↵Alexander 'Binärpilot' Støver (music): http://binaerpilot.no↵↵asdfmovie2 / asdfmovie2: deleted scenes↵Edd 'Eddsworld' Gould (animator): http://www.youtube.com/eddsworld↵Stephen 'Sherbethead (music):  http://www.youtube.com/user/sherbethe...↵↵asdfmovie3↵Jamie 'RageNineteen' Spicer-Lewis (animator): http://www.youtube.com/ragenineteen↵Retrospekt (intro music): http://www.twitter.com/retrospektuk↵↵asdfmovie5:↵Jamie 'RageNineteen' Spicer-Lewis (animator): http://www.youtube.com/ragenineteen↵Yoav 'TheLivingTombstone' Landau (music): http://youtube.com/thelivingtombstone↵↵asdfmovie4/6/7/deleted scenes/8/9/10/11↵Ben 'Wonchop' Smallman (animator): http://youtube.com/WonchopAnimation↵Todd 'LilDeuceDeuce' Bryanton (music): http://youtube.com/LilDeuceDeuce↵↵For cast/additional credits, watch the actual asdfmovies, ya goober.↵↵Main Channel (http://youtube.com/TomSka)↵Twitter (http://twitter.com/thetomska)↵Facebook (http://fb.com/thetomska)↵Tumblr (http://thetomska.tumblr.com)";
// image: 'https://i.ytimg.com/vi/2CeurT8vjU0/mqdefault.jpg';
// title: 'asdfmovie 1-11 (Complete Collection)';
// view: '9702515';
